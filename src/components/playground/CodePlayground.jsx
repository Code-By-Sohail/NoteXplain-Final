...
const Icons = {
    ...
    Bash: ({ className }) => (
        <svg viewBox="0 0 128 128" className={className}>
            ...
            <path fill="#FFFFFF" d="M64 15L95 35L95 75L64 95L33 75L33 35Z" />
            <text x="50" y="58" fill="#2D2D30" fontSize="32" fontWeight="bold" fontFamily="monospace">$</text>
            <text x="64" y="58" fill="#2D2D30" fontSize="32" fontWeight="bold" fontFamily="monospace">_</text>
        </svg>
    ),
};
...
`);
    ...
    const LANGUAGES = [
        ...
        { id: 'bash', name: 'Shell', icon: Icons.Bash, color: 'text-green-400' },
    ];
